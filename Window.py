...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.about = QPushButton(self.firstPage)
        self.about.setObjectName(u"about")
        self.about.setGeometry(QRect(221, 329, 270, 40))
        self.countdown = QPushButton(self.firstPage)
        self.countdown.setObjectName(u"countdown")
        self.countdown.setGeometry(QRect(221, 244, 270, 40))
        self.timer = QPushButton(self.firstPage)
        self.timer.setObjectName(u"timer")
        self.timer.setGeometry(QRect(221, 159, 270, 40))
        ...
        self.fullDisplayBtn1.setGeometry(QRect(230, 320, 270, 40))
        ...
        self.startBtn.setGeometry(QRect(290, 280, 120, 30))
